      ...
      <div style="max-height: 200px; overflow-y: auto">
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ period.remark }}</td>
              <td>{{ period.totalAmount | number : "1.2-2" }}</td>
              <td>{{ period.totalIncome | number : "1.2-2" }}</td>
              <td>{{ period.orderAmount | number : "1.2-2" }}</td>
...
export class OtherIncomeProductPeriodComponent {
