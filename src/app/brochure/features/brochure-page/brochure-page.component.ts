...
import { BrochureSpecialCardComponent } from "../../components/brochure-special-card/brochure-special-card.component";
import { BrochureCardComponent } from "../../components/brochure-card/brochure-card.component";
...
export class BrochurePageComponent {
  ...
  color = computed<TColor>(() => zoneToColor(this.zone()))
  date = computed(() => {
  ...
  private readonly addHour = (date: string) => {
